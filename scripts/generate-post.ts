...
10. 본문은 반드시 <h2> 섹션 4개로 구성하세요 (TMI 한 줄 요약 <h2> 포함하면 총 5개)
    - 예: <h2>첫 번째 핵심 내용</h2> ... <h2>두 번째 내용</h2> ... <h2>세 번째 내용</h2> ... <h2>네 번째 내용</h2> ... <h2>💡 TMI 한 줄 요약</h2>
11. 글 마지막에 반드시 "💡 TMI 한 줄 요약" 섹션 포함
